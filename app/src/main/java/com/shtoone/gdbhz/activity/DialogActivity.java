...
import com.shtoone.gdbhz.bean.BHZEquipment;
import com.shtoone.gdbhz.bean.DesignStrengthData;
import com.shtoone.gdbhz.bean.EquipmentAndTestTypeData;
import com.shtoone.gdbhz.bean.MaterialListData;
import com.shtoone.gdbhz.bean.ParametersData;
import com.shtoone.gdbhz.bean.StorageMaterialData;
import com.shtoone.gdbhz.bean.WaagListData;
...
import static com.shtoone.gdbhz.BaseApplication.mDepartmentData;
...
//        ms_select_materialname = (MaterialSpinner) findViewById(R.id.ms_select_materialname_dialog);
        ...
        ed_lingqi = (EditText) findViewById(R.id.ed_lingqi_choose);
        ...
        switch (mParametersData.fromTo) {
            ...
            case ConstantsUtils.TODAYSYSTEMQUERY:
                ...
                ms_select_strength.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        if (i >= 0) {
                            mParametersData.todaysjqd = sjqdDataArr[i];
                        } else if (i == -1) {
                            mParametersData.todaysjqd = "";
                        }
                    }
            ...
            case ConstantsUtils.WANNENGJIFRAGMENT:
                ...
                url = URL.getBHZEquipment(mParametersData.userType,mParametersData.biaoshiid,"4");
                refresh();
            ...
            case ConstantsUtils.YALIJIFRAGMENT:
                ...
                url = URL.getBHZEquipment(mParametersData.userType,mParametersData.biaoshiid,"3");
...
//                break;
            ...
            case ConstantsUtils.PRODUCEQUERYFRAGMENT:
                //设置设备的下拉选择可见
                ms_select_equipment.setVisibility(View.VISIBLE);
                url = URL.getBHZEquipment(mParametersData.userType,mParametersData.biaoshiid,"1");
                refresh();
                break;
...
//        equipmentsAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//        ms_select_materialname.getAdapter(equipmentsAdapter);
//
...
//    }
    ...
    private void setBHZQueryView() {
        equipmentNames = new ArrayList<>();
        equipmentIDs = new ArrayList<>();
        for (BHZEquipment.DataEntity temp : mBHZEquipment.getData()) {
            equipmentNames.add(temp.getBanhezhanminchen());
            equipmentIDs.add(temp.getGprsbianhao());
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_search_dialog:
                ...
                mParametersData.jiaozhubuwei= ed_jzbw.getText().toString().trim();
                mParametersData.todaylp = ed_lingqi.getText().toString().trim();
