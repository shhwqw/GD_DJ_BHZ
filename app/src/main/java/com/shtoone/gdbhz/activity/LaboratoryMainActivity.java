...
import com.shtoone.gdbhz.bean.LaboratoryMainActivityData;
...
public class LaboratoryMainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void initData() {
      ...
      /*  if (null != mToolbar && null != BaseApplication.mUserInfoData && !TextUtils.isEmpty(BaseApplication.mUserInfoData.getDepartName())) {
        ...
        if (null != mToolbar && null != BaseApplication.mUserInfoData && !TextUtils.isEmpty(BaseApplication.mUserInfoData.getUserFullName())) {
    ...
    public String createRefreshULR() {
        String libSGMainUrl = URL.getLibSGMain(BaseApplication.mDepartmentData.departmentID);
        Log.e("实验室url","url=:"+libSGMainUrl);
        return URL.getLibSGMain(BaseApplication.mDepartmentData.departmentID);
    }

    @Override
    public void onRefreshSuccess(String response) {
        Log.e("当前response","response=:"+response.toString());
