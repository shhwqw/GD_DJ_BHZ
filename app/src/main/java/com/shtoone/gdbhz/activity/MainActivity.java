...
import com.shtoone.gdbhz.fragment.mainactivity.ConcreteFragment;
import com.shtoone.gdbhz.fragment.mainactivity.LaboratoryFragment;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            Log.e(TAG, "mFragments[0]:" + mFragments[0]);
            Log.e(TAG, "mFragments[1]:" + mFragments[1]);
    ...
    public void initData() {
        ...
        /***********************************************/
        int[] bottomTitles = {R.string.concrete, R.string.laboratory};
        int[] bottomIcons = {R.drawable.ic_bhz, R.drawable.ic_lab};
        int[] bottomBackgroundColors = {R.color.white, R.color.material_yellow_100};
