...
import com.shtoone.gdbhz.adapter.WannengjiDetailActivityChartViewPagerAdapter;
...
public class WannengjiDetailActivity extends BaseActivity {
    ...
    private WannengjiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity mDataBean;
    private Gson mGson;
    ...
    private void initView() {
        mDataBean = (WannengjiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity) getIntent().getSerializableExtra("wannengjidetail");
    ...
    private void submit(final MaterialDialog progressDialog) {
        ...
        paramsMap.put("xxid", mDataBean.getSYJID());
        paramsMap.put("beizhu", handleReason);
