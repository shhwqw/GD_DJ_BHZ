...
import com.shtoone.gdbhz.adapter.FBProjectTreeListViewAdapter;
import com.shtoone.gdbhz.bean.FBDataBean;
import com.shtoone.gdbhz.bean.FENBUProjectData;
...
//            mAdapter = new FBProjectTreeListViewAdapter<>(treeListView, this, treeNodes, 1);
      ...
      /*  treeListView.getAdapter(mAdapter);
        mAdapter.setOnTreeNodeClickListener(new TreeListViewAdapter.OnTreeNodeClickListener() {
            @Override
            public void onClick(Node node, int position) {
                mParametersData.projectno = node.getId();
