...
public class OverproofDetailActivityRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<OverproofDetailActivityData.DataEntity> itemsData;
    private Resources mResources;

    public OverproofDetailActivityRecyclerViewAdapter(Context context, List<OverproofDetailActivityData.DataEntity> itemsData) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            OverproofDetailActivityData.DataEntity item = itemsData.get(position);
