...
public class ProduceQueryFragmentRecyclerViewAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            mItemViewHolder.tv_datetime.setText(item.getShijian());
            mItemViewHolder.tv_site.setText(item.getBanhezhanmingchen());
            mItemViewHolder.tv_project_name.setText(item.getGcmc());
            mItemViewHolder.tv_position.setText(item.getJzbw());
