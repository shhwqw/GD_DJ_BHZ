...
public class WannengjiFragmentViewPagerFragmentRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<WannengjiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity> itemsData;
    ...
    public WannengjiFragmentViewPagerFragmentRecyclerViewAdapter(Context context, List<WannengjiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity> itemsData) {
        super();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            WannengjiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity item = itemsData.get(position);
            Log.e(TAG,"item=:"+item);
            mItemViewHolder.tv_title.setText(item.getSYRQ());
            mItemViewHolder.tv_equipment.setText(item.getJianchen());
            ...
            if ("合格".equals(item.getPDJG())) {
                ...
                if (!TextUtils.isEmpty(item.getBEIZHU())) {
                    //默认就是已处置
                } else {
