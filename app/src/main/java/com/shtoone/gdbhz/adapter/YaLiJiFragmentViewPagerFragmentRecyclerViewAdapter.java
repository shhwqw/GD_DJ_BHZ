...
public class YaLiJiFragmentViewPagerFragmentRecyclerViewAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private List<YalijiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity> itemsData;
    ...
    public YaLiJiFragmentViewPagerFragmentRecyclerViewAdapter(Context context, List<YalijiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity> itemsData) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            YalijiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity item = itemsData.get(position);
