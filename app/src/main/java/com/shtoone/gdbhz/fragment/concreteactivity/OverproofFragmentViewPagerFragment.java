...
import com.shtoone.gdbhz.activity.OverproofDetailActivity;
import com.shtoone.gdbhz.adapter.OnItemClickListener;
import com.shtoone.gdbhz.adapter.OverproofFragmentViewPagerFragmentRecyclerViewAdapter;
...
public class OverproofFragmentViewPagerFragment extends BaseFragment {
    ...
    public String createRefreshULR() {
        ...
        if (null != mParametersData) {
            ...
            chaobiaolx = mParametersData.alarmLevel;
            cllx = mParametersData.handleType;
        ...
        return URL.getOverproofData(departType, biaoshiid, startTime, endTime, pageNo, chaobiaolx, cllx,shebeibianhao);
    }
    ...
    public String createLoadMoreULR() {
        ...
        Log.e(TAG,"超标url=:"+URL.getOverproofData(departType, biaoshiid, startTime, endTime, pageNo, chaobiaolx, cllx,shebeibianhao));
        return URL.getOverproofData(departType, biaoshiid, startTime, endTime, pageNo, chaobiaolx, cllx,shebeibianhao);
    }
    ...
    private void jump2OverproofDetailActivity(int position) {
        ...
        Log.e(TAG,"id:"+listData.get(position).getId());
        intent.putExtra("id","");
