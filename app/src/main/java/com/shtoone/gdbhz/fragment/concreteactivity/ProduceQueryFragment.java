...
import com.shtoone.gdbhz.activity.ProduceQueryDetailActivity;
import com.shtoone.gdbhz.adapter.OnItemClickListener;
import com.shtoone.gdbhz.adapter.ProduceQueryFragmentRecyclerViewAdapter;
import com.shtoone.gdbhz.bean.ParametersData;
import com.shtoone.gdbhz.bean.ProduceQueryFragmentListData;
...
public class ProduceQueryFragment extends BaseLazyFragment {
    ...
    private void initData() {
        ...
        mParametersData.biaoshiid = BaseApplication.parametersData.biaoshiid;
...
//        initToolbarMenu(mToolbar);
    ...
    public String createRefreshULR() {
        ...
        if (null != mParametersData) {
            ...
            /*departType = mParametersData.userGroupID;
        ...
        return URL.getProduceData(departType, biaoshiid, startTime, endDateTime, pageNo,equipmentID);
    }
