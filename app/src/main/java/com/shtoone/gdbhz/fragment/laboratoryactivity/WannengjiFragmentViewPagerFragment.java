...
import com.shtoone.gdbhz.adapter.WannengjiFragmentViewPagerFragmentRecyclerViewAdapter;
import com.shtoone.gdbhz.bean.DepartmentData;
import com.shtoone.gdbhz.bean.ParametersData;
import com.shtoone.gdbhz.bean.WannengjiFragmentViewPagerFragmentRecyclerViewItemData;
...
public class WannengjiFragmentViewPagerFragment extends BaseFragment {
    ...
    private List<WannengjiFragmentViewPagerFragmentRecyclerViewItemData.DataEntity> listData;
    private Gson mGson;
...
//        String pageNo, String maxPageItems, String lingqi, String sjqd,String pdjg,String isReal)
        String wanNengTestUrl = URL.getWannengjiTestList(departType, biaoshiid, startDateTime, endDateTime, shebeibianhao, pageNo, maxPageItems, lingqi, pdjg, isReal);
        Log.e("万能机url", "万能机url=:" + wanNengTestUrl);
        //departType=%1&biaoshiid=%2&startTime=%3&endTime=%4&shebeibianhao=%5&pageNo=%6&maxPageItems=%7&lingqi=%8&pdjg=%9&isReal=%aa
        return wanNengTestUrl;
    }
...
//            sjqd = mParametersData.sjqd;
        ...
        String wanNengTestUrl = URL.getYalijiTestList(departType, biaoshiid, startDateTime, endDateTime, shebeibianhao, pageNo, maxPageItems, lingqi, pdjg, isReal);
        Log.e("万能机url", "万能机url=:" + wanNengTestUrl);
        //departType=%1&biaoshiid=%2&startTime=%3&endTime=%4&shebeibianhao=%5&pageNo=%6&maxPageItems=%7&lingqi=%8&pdjg=%9&isReal=%aa
        return wanNengTestUrl;
    }
