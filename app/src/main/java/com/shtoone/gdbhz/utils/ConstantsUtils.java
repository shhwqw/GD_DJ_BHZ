...
public class ConstantsUtils {
    ...
    public static final int REFRESH_ENGINEER_DEPARTMENT = 26;
    ...
    public static final int TODAYSYSTEMQUERY = 50;
    public static final int MAINTAINEDIT = 51;
    public static final int QRCODEPROCESS = 52;
}
